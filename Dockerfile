...
RUN \
  ...
  add-apt-repository ppa:ondrej/php && apt-get install -y curl composer apache2 libapache2-mod-fcgid libapache2-mod-wsgi-py3 \
  php7.4-fpm php7.4-common php7.4-mysql php7.4-xml php7.4-xmlrpc php7.4-curl php7.4-gd php7.4-imagick \
  php7.4-cli php7.4-dev php7.4-imap php7.4-mbstring php7.4-soap php7.4-zip php7.4-bcmath php7.1-fpm php7.4-intl \
  php7.1-common php7.1-mysql php7.1-xml php7.1-xmlrpc php7.1-curl php7.1-gd php7.1-imagick php7.1-intl \ 
  php7.1-cli php7.1-dev php7.1-imap php7.1-mbstring php7.1-soap php7.1-zip php7.1-bcmath python3-pip glances && pip install virtualenv &&\
  curl -fsSL https://deb.nodesource.com/setup_16.x | bash - && apt install -y nodejs && npm install -g yarn &&\
  curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh | bash && \
  a2enmod proxy_fcgi setenvif wsgi && wget https://files.phpmyadmin.net/phpMyAdmin/5.1.1/phpMyAdmin-5.1.1-all-languages.zip && \
  unzip phpMyAdmin-5.1.1-all-languages.zip && mv phpMyAdmin-5.1.1-all-languages /usr/share/phpmyadmin && \
